...
namespace e_Movies_Platform.Data.Migrations
{
    ...
    [Migration("20230207204150_updatedWishList")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("e_Movies_Platform.Models.WishList", b =>
                {
                    b.Property<int?>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("e_Movies_Platform.Models.CastCrew", b =>
                {
                    b.HasOne("e_Movies_Platform.Models.CastCrewRole", "Role")
                        .WithMany()
            ...
            modelBuilder.Entity("e_Movies_Platform.Models.Movie", b =>
                {
                    b.HasOne("e_Movies_Platform.Models.Genre", "Genre")
                        .WithMany()
            ...
            modelBuilder.Entity("e_Movies_Platform.Models.WishList", b =>
                {
                    b.HasOne("e_Movies_Platform.Models.ApplicationUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("e_Movies_Platform.Models.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
